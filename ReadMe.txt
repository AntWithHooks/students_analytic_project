Имеется задача - проанализировать полученные данные и оценить активность студентов.

Задача разбита на подзадачи:
1. Найти сколько студентов успешно сдали только один курс.
...
Все комментарии по решению, решение и ответы в Project.ipynb

Имеются следующие данные с колонками:
